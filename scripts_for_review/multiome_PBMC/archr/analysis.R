...
input_files <- "/home/yuanh/sc_basset/datasets/10x_ARC_PBMC/raw/pbmc_granulocyte_sorted_3k_atac_fragments.tsv.gz"
addArchRGenome("hg38")
...
dir.create("PBMC_proj/Plots")
pdf("PBMC_proj/Plots/QC_TSSenrich.pdf", 8, 6)
print(p1)
dev.off()
...
pdf("PBMC_proj/Plots/QC_log10_nFrags.pdf", 8, 6)
print(p2)
dev.off()
...
# LSI #
#######
proj <- loadArchRProject("PBMC_proj/")
