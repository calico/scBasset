...
# filter barcodes
x.sp = createSnap(
    file="pbmc_granulocyte_sorted_3k_atac_fragments.snap",
...
showBinSizes("pbmc_granulocyte_sorted_3k_atac_fragments.snap")
x.sp = addBmatToSnap(x.sp, bin.size=5000, num.cores=8)
x.sp = makeBinary(x.sp, mat="bmat") #binarize (following tutorial)

# remove blacklist
black_list = read.table("/home/yuanh/genomes/hg38/hg38.blacklist.bed.gz");
